...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-genemodel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7999&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-genemodel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-genemodel` can be installed with:

```
conda install r-genemodel
```

It is possible to list all of the versions of `r-genemodel` available on your platform with:
